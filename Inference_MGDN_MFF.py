...
from models.MGFF.DYKPN import MGFF as net
...
def main():
    ...
    parser.add_argument('--task', type=str, default='fusion', help='classical_sr, lightweight_sr, real_sr,''gray_dn, color_dn, jpeg_car')
    parser.add_argument('--scale', type=int, default=1, help='scale factor: 1, 2, 3, 4, 8')  # 1 for dn and jpeg car
    parser.add_argument('--large_model', action='store_true', help='use large model, only provided for real image sr')
    parser.add_argument('--model_path', type=str,default='')
    parser.add_argument('--iter_number', type=str,default='10000')
    parser.add_argument('--root_path', type=str, default='./Dataset/',help='input test image root folder')
    parser.add_argument('--dataset', type=str, help='input test image name')
    parser.add_argument('--B_dir', type=str, default='VI_Y', help='input test image name')
    parser.add_argument('--A_dir', type=str, default='IR', help='input test image name')
    ...
    for i, test_data in enumerate(test_loader):
        ...
        print("===>", test_data['A_path'][0])
        print("===>", test_data['B_path'][0])
...
def define_model(args):
    model = net(GF_chans=30,embed_dim=30, depths=[3, 3], num_heads=[3, 3], window_size=4, kernel_num = [1,1,1],mlp_ratio=2.,inference=False)
    param_key_g = 'params'
...
def remove_module(load_net):
    ...
    for k, v in load_net.items():
        if k.startswith('module.'):
            ...
            load_net_clean[k] = v
    return load_net_clean


def setup(args):
    save_dir = f'./Results/MFF/'
